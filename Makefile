...
ACLOCAL = ${SHELL} /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c/missing autoconf
AUTOHEADER = ${SHELL} /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c/missing autoheader
AUTOMAKE = ${SHELL} /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c/missing automake-1.13
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 2.6
abs_builddir = /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c
abs_srcdir = /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c
abs_top_builddir = /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c
abs_top_srcdir = /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/anthony/Documents/Programmes/Linux/Programmes_Rust/gsl_dev/gsl_src_c/install-sh
...
top_builddir = .
top_srcdir = .
SUBDIRS = gsl utils sys test err bst const complex cheb block vector matrix permutation combination multiset sort ieee-utils cblas blas linalg eigen specfunc dht qrng rng randist fft poly fit multifit multifit_nlinear multilarge multilarge_nlinear filter movstat rstat statistics siman sum integration interpolation histogram ode-initval ode-initval2 roots multiroots min multimin monte ntuple diff deriv cdf wavelet bspline spblas spmatrix splinalg doc
SUBLIBS = block/libgslblock.la blas/libgslblas.la \
	bspline/libgslbspline.la bst/libgslbst.la \
	complex/libgslcomplex.la cheb/libgslcheb.la dht/libgsldht.la \
	diff/libgsldiff.la deriv/libgslderiv.la eigen/libgsleigen.la \
	err/libgslerr.la fft/libgslfft.la filter/libgslfilter.la \
	...
	multifit/libgslmultifit.la \
	multifit_nlinear/libgslmultifit_nlinear.la \
	multilarge/libgslmultilarge.la \
	multilarge_nlinear/libgslmultilarge_nlinear.la \
	multimin/libgslmultimin.la multiroots/libgslmultiroots.la \
	ntuple/libgslntuple.la ode-initval/libgslodeiv.la \
	ode-initval2/libgslodeiv2.la permutation/libgslpermutation.la \
	...
	movstat/libgslmovstat.la rstat/libgslrstat.la \
	...
	wavelet/libgslwavelet.la spmatrix/libgslspmatrix.la \
	spblas/libgslspblas.la splinalg/libgslsplinalg.la
